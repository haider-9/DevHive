...
import { LuBell, LuSearch, LuMoon, LuSun, LuCheck, LuMessageSquare, LuHeart, LuStar } from "react-icons/lu";
...
const Navbar = () => {
  ...
  return (
    <div className="hidden md:flex justify-around items-center *:bg-primary *:px-4 *:pb-4 *:rounded-b-2xl">
        ...
        <div className="transition-transform duration-300 hover:scale-110">
          ...
          >
            ...
            <DropdownMenu 
              ...
              closeOnSelect={false}
            >
              <DropdownItem key="header" className="h-14 flex justify-between items-center" textValue="Notifications">
              ...
              {notifications.length === 0 ? (
                <DropdownItem key="empty" className="h-24 flex items-center justify-center" textValue="No notifications">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm mt-1">
                          ...
                          {notification.post && (
                            <span className="font-medium"> on "{notification.post}"</span>
                          )}
                        </p>
              ...
              <DropdownItem key="view-all" className="h-12 flex justify-center items-center text-warning" textValue="View all notifications">
                <Button 
                  as="a" 
                  href="/notifications" 
                  variant="light" 
...
// Export the notification components to be reused in Sidebar
export const NotificationDropdown = ({ notifications, markAsRead, markAllAsRead, unreadCount }) => (
